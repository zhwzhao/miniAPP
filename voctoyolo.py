...
def voc2yolo(filename):
    # classes_dict = {}
    # with open("/media/hzq/G/Github/traffic_sign/voc_transform_yolo/classes.names") as f:
    ...
    img_path = './train/' + filename.split('\\')[-1].replace('xml', 'jpg')
...
if __name__ == "__main__":
    ...
    for xml_path in xml_path_list:
        voc2yolo(xml_path)
    print(count)
    # imglist = get_image_list("/media/hzq/G/Github/traffic_sign/voc_transform_yolo/images")
